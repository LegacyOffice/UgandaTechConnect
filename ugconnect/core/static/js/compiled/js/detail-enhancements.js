...
export class DetailEnhancements {
    constructor(app) {
        ...
        this.shareButton = document.querySelector('[data-action="share"]');
        this.printButton = document.querySelector('[data-action="print"]');
        this.favoriteButton = document.querySelector('[data-action="favorite"]');
    ...
    setupContentNavigation() {
        if (this.contentSections.length <= 2)
            return;
    ...
    getTooltipText(button) {
        ...
        if (iconClass.includes('edit'))
            return 'Edit';
        if (iconClass.includes('delete') || iconClass.includes('trash'))
            return 'Delete';
        if (iconClass.includes('share'))
            return 'Share';
        if (iconClass.includes('print'))
            return 'Print';
        if (iconClass.includes('heart') || iconClass.includes('favorite'))
