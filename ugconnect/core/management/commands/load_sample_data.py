...
class Command(BaseCommand):
    help = 'Create comprehensive sample data for UgandaTechConnect'

    def handle(self, *args, **options):
        self.stdout.write("🚀 Creating Sample Data for UgandaTechConnect")
        ...
        with transaction.atomic():
            ...
            self.stdout.write(f"  • Outcomes: {Outcome.objects.count()}")
            self.stdout.write(f"\n✨ UgandaTechConnect database is now populated with comprehensive sample data!")
